...
+ (NSTimeInterval)getTimeOutTimeInterval {
    
    return SO_TIMEOUT;
    
}

+ (NSString *)getRequestDataStr:(NSString *)bssid {
    
    NSString *realRequestDataStr = bssid == nil ? REQUEST_DATA_STR : [NSString stringWithFormat:@"%@ %@",REQUEST_DATA_STR,bssid];
    return realRequestDataStr;
}

+ (NSArray *)parsingDevicesWithResponseString:(NSString *)responseStr
{
...
//        // send request
//        NSLog(@"草泥马草泥马 %@",realRequestDataStr);
